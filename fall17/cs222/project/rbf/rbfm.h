...
const int SLOT_SIZE = sizeof(int);
...
public:
  ...
  RC getNextRecord2(RID &rid, void *data);// { return RBFM_EOF; };
  RC close(); // { return -1; };

public:

    int prepareOutputRecord(const void* rbuff, void* data);
    bool checkCondition(const void* rbuff);
